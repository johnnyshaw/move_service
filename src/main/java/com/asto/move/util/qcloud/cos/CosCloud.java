...
import com.asto.move.util.qcloud.cos.common.HMACSHA1;
import com.asto.move.util.qcloud.cos.common.Request;
...
public class CosCloud {
	...
	public CosCloud(int appId, String secretId, String secretKey){
		this(appId, secretId, secretKey, 600000);
	}
	 ...
	 * @param secretKey	 授权secret key
	 */
	public CosCloud(int appId, String secretId, String secretKey,String bucketName){
		this(appId, secretId, secretKey,bucketName, 600000);
	}
	 ...
	 * @param timeOut	网络超时
	 */
	public CosCloud(int appId, String secretId, String secretKey, String bucketName, int timeOut){
		this.appId = appId;
		this.secretId = secretId;
		this.secretKey = secretKey;
	...
	public String getFileStat(String bucketName, String remotePath) throws Exception{
		...
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("op", "stat");
		long expired = System.currentTimeMillis() / 1000 + 600000;
	 ...
	 * @throws Exception 
	 */
	public String createFolder(String remotePath) throws Exception{
		remotePath = standardizationRemotePath(remotePath);
		String url = COSAPI_CGI_URL + appId + "/" + bucketName + encodeRemotePath(remotePath);
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("op", "create");
	 ...
	 * @throws Exception 
	 */
	public String getFolderList(String remotePath, int num, String offset, int order, FolderPattern pattern) throws Exception{
		remotePath = standardizationRemotePath(remotePath);
	 ...
	 * @throws Exception 
	 */
	public String uploadFile(String remotePath, String localPath) throws Exception{
	 ...
	 * @throws Exception 
	 */
	public String sliceUploadFile(String remotePath, String localPath) throws Exception{
		return sliceUploadFile(MoveConstant.COS_BUCKETNAME, remotePath, localPath, 50 * 1024 * 1024);
	}
